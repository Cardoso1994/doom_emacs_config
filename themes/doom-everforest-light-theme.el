;;; doom-everforest-light-theme.el --- inspired by Atom One Dark -*- no-byte-compile: t; -*-
(require 'doom-themes)
...
(def-doom-theme doom-everforest-light
  ...
  ((bg         `(,efl/bg         nil       nil            ))
   ...
   (selection      dark-blue)
   (builtin        magenta)
   (comments       (if doom-everforest-light-brighter-comments cyan base5))
   (doc-comments   (doom-lighten (if doom-everforest-light-brighter-comments dark-cyan base5) 0.25))
   (constants      violet)
   (functions      cyan)
   (keywords       red)
   (methods        cyan)
  ...
  ((elscreen-tab-other-screen-face :background "#353a42" :foreground "#1e2022")
   ...
   ;; evil
   (evil-ex-lazy-highlight :foreground fg :background (doom-lighten magenta 0.2))

   ;; vertico
   (vertico-current :foreground fg :background (doom-lighten yellow 0.7))
   ;; others
